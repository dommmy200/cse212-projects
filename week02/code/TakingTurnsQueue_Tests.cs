...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: In the PersonQueue.cs file, Insert(0, person) is replaced with Add(person)
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: An "else-if" clause to check if person.Turns <= 0 is true, reset Turns = 0 and enqueue
    // such person object.
